...
def parse_filter_state(specs: Iterable[FilterSpec], querydict: QueryDict) -> dict[str, Any]:
...
def serialize_filter_state(specs: Iterable[FilterSpec], state: Mapping[str, Any]) -> QueryDict:
...
def _parse_date_range(querydict: QueryDict, param_name: str) -> dict[str, str | None] | None:
...
def _parse_numeric_range(querydict: QueryDict, param_name: str) -> dict[str, float | None] | None:

...
DEFAULT_THEME_ADAPTER = ThemeAdapter(
    name="default",
    controls_template="admin/django_smart_filters/theme/default/filter_controls.html",
    active_bar_template="admin/django_smart_filters/theme/default/active_filters_bar.html",
)
